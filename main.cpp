...
void update(string input_file, string hash_file, string output_file, bool fixed_manifest, string fixed_dir) {
...
int main(int argc, char** argv) {
    ...
    for ( ; i < argc; ++i) {
        ...
        if (s[1] == 'i') {
            ...
            fixed_manifest = true;
            if (FindKeyWordEndFix(the_rest, "/")) {
                fixed_dir = the_rest.substr(0, the_rest.length()-1);
            }
            else
                fixed_dir = the_rest;
            listFiles(fixed_dir);
    ...
    update(input_file, hash_file, output_file, fixed_manifest, fixed_dir);
